...
const PaymentSection = ({
  ...
  const Data = useStaticQuery(graphql`
    query {
      mockup: file(relativePath: { eq: "image/app/mockup.png" }) {
        childImageSharp {
          gatsbyImageData(
            width: 860
            placeholder: BLURRED
      ...
      creditCard: file(relativePath: { eq: "image/app/credit-card.png" }) {
        childImageSharp {
          gatsbyImageData(
            width: 454
            placeholder: BLURRED
          ...
          <Box {...col} {...imageArea}>
            <Card {...imageWrapper} {...imageWrapperOne}>
              <Fade left>
                <GatsbyImage
                  src={
                    (Data.mockup !== null) | undefined
                      ? Data.mockup.childImageSharp.gatsbyImageData
                      : {}
                  }
                  alt="mockup"
                />
            ...
            >
              <Fade right>
                <GatsbyImage
                  src={
                    (Data.creditCard !== null) | undefined
                      ? Data.creditCard.childImageSharp.gatsbyImageData
                      : {}
                  }
                  alt="Credit Card"
                />
